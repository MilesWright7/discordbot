...
def send_nudes(userId, channel : discord.channel.TextChannel):
	channel.send(f"<@{userId}> its your turn to pick now bruv.\n https://docs.google.com/spreadsheets/d/1JT5zDoT9ind7NOgk_MF4MkI-9R97JKForhYxSEYSKs0/edit#gid=1822506900")
