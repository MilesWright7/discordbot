...
class Loop(commands.Cog):
	...
	@commands.hybrid_command(help="Loops queue, finished songs are added to the end. can also use =l", aliases=["l"])
	...
	@commands.hybrid_command(help="Turns off looping can also use =sl", aliases=["sl"])
